...
execute as @e[type=!#hh:warden_targetable] store result score @s hhUUID1 run data get entity @s UUID[0]
execute as @e[type=!#hh:warden_targetable] store result score @s hhUUID2 run data get entity @s UUID[1]
execute as @e[type=!#hh:warden_targetable] store result score @s hhUUID3 run data get entity @s UUID[2]
execute as @e[type=!#hh:warden_targetable] store result score @s hhUUID4 run data get entity @s UUID[3]
