...
execute if score @s hhUUID1 = @e[type=marker,tag=hhDeathMarker,tag=!hhNoRespawn,sort=nearest,limit=1] hhUUID1 run scoreboard players add @s hhUUIDMatch 1
execute if score @s hhUUID2 = @e[type=marker,tag=hhDeathMarker,tag=!hhNoRespawn,sort=nearest,limit=1] hhUUID2 run scoreboard players add @s hhUUIDMatch 1
execute if score @s hhUUID3 = @e[type=marker,tag=hhDeathMarker,tag=!hhNoRespawn,sort=nearest,limit=1] hhUUID3 run scoreboard players add @s hhUUIDMatch 1
execute if score @s hhUUID4 = @e[type=marker,tag=hhDeathMarker,tag=!hhNoRespawn,sort=nearest,limit=1] hhUUID4 run scoreboard players add @s hhUUIDMatch 1
...
#remove player tag
tag @e[type=marker,tag=hhPlayerRevive,sort=nearest,limit=1] remove hhPlayerRevive